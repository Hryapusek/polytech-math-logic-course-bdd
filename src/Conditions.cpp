...
TEST_F(VarsSetupFixture, Conditions_LoopCondition)
{
  ...
  expectedResult |= h.getHouseAndVal(House::SIXTH, H_Color::RED);
  expectedResult |= h.getHouseAndVal(House::SEVENTH, H_Color::RED);
  expectedResult |= h.getHouseAndVal(House::EIGTH, H_Color::RED);
  expectedResult |= h.getHouseAndVal(House::NINETH, H_Color::RED);
...
TEST_F(VarsSetupFixture, Conditions_NeighborsCondition)
{
  ...
  expectedResult |= h.getHouseAndVal(House::FIFTH, H_Color::RED) & h.getHouseAndVal(House::SIXTH, H_Color::GREEN);
  
  expectedResult |= h.getHouseAndVal(House::SIXTH, H_Color::RED) & h.getHouseAndVal(House::FIFTH, H_Color::GREEN);
  expectedResult |= h.getHouseAndVal(House::SIXTH, H_Color::RED) & h.getHouseAndVal(House::SEVENTH, H_Color::GREEN);
  
  expectedResult |= h.getHouseAndVal(House::SEVENTH, H_Color::RED) & h.getHouseAndVal(House::SIXTH, H_Color::GREEN);
  expectedResult |= h.getHouseAndVal(House::SEVENTH, H_Color::RED) & h.getHouseAndVal(House::EIGTH, H_Color::GREEN);
  
  expectedResult |= h.getHouseAndVal(House::EIGTH, H_Color::RED) & h.getHouseAndVal(House::SEVENTH, H_Color::GREEN);
  expectedResult |= h.getHouseAndVal(House::EIGTH, H_Color::RED) & h.getHouseAndVal(House::NINETH, H_Color::GREEN);
  
  expectedResult |= h.getHouseAndVal(House::NINETH, H_Color::RED) & h.getHouseAndVal(House::EIGTH, H_Color::GREEN);
  EXPECT_EQ(build.result(), expectedResult);
}
